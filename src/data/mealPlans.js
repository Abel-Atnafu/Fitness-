...
export const MEAL_PLANS = [
  {
    ...
    meals: {
      breakfast: {
        ...
        alternates: [ALT_BF_SAMBUSA, ALT_BF_SCRAMBLED],
      },
      lunch: {
        ...
        alternates: [ALT_LU_SHIRO, ALT_LU_DULET],
      },
      dinner: {
        ...
        alternates: [ALT_DN_FISH_RICE, ALT_DN_PIZZA],
      },
    },
    totalCalories: 1895,
  },
  {
    ...
    meals: {
      breakfast: {
        ...
        alternates: [ALT_BF_SMOOTHIE, ALT_BF_SAMBUSA],
      },
      lunch: {
        ...
        alternates: [ALT_LU_CHICKEN_SALAD, ALT_LU_SHIRO],
      },
      dinner: {
        ...
        alternates: [ALT_DN_MISIR_FIRFIR, ALT_DN_FISH_RICE],
      },
    },
    totalCalories: 1910,
  },
  {
    ...
    meals: {
      breakfast: {
        ...
        alternates: [ALT_BF_SCRAMBLED, ALT_BF_SMOOTHIE],
      },
      lunch: {
        ...
        alternates: [ALT_LU_DULET, ALT_LU_CHICKEN_SALAD],
      },
      dinner: {
        ...
        alternates: [ALT_DN_PIZZA, ALT_DN_MISIR_FIRFIR],
      },
    },
    totalCalories: 1880,
  },
  {
    ...
    meals: {
      breakfast: {
        ...
        alternates: [ALT_BF_SAMBUSA, ALT_BF_SMOOTHIE],
      },
      lunch: {
      ...
      dinner: {
        ...
        alternates: [ALT_DN_FISH_RICE, ALT_DN_MISIR_FIRFIR],
      },
    },
    totalCalories: 1900,
  },
  {
    ...
    meals: {
      breakfast: {
        ...
        alternates: [ALT_BF_SCRAMBLED, ALT_BF_SAMBUSA],
      },
      lunch: {
        ...
        alternates: [ALT_LU_DULET, ALT_LU_SHIRO],
      },
      dinner: {
        ...
        alternates: [ALT_DN_PIZZA, ALT_DN_FISH_RICE],
      },
    },
    totalCalories: 1920,
  },
  {
    ...
    meals: {
      breakfast: {
        ...
        alternates: [ALT_BF_SMOOTHIE, ALT_BF_SCRAMBLED],
      },
      lunch: {
        ...
        alternates: [ALT_LU_CHICKEN_SALAD, ALT_LU_DULET],
      },
      dinner: {
        ...
        alternates: [ALT_DN_MISIR_FIRFIR, ALT_DN_PIZZA],
      },
    },
    totalCalories: 1870,
  },
